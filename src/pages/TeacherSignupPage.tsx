  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full py-6 text-lg bg-blue-600 hover:bg-blue-700" disabled={loading}>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link to="/login/teacher" className="text-primary hover:underline font-medium">
              Sign in as Teacher
            </Link>
          </p>
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            Are you a student?{' '}
            <Link to="/signup/student" className="text-purple-600 hover:underline font-medium">
              Student Signup
            </Link>
          </p>
        </motion.div>
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6 }}
        className="hidden lg:flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 p-12 relative overflow-hidden"
      >
        ...
        <div className="relative z-10 text-white text-center max-w-md">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join educators using AI-powered analytics to enhance student engagement and performance
          </p>
          <div className="space-y-4 text-left">
            {['Track student attendance', 'AI-powered insights', 'Manage multiple classes', 'Real-time analytics'].map((feature) => (
